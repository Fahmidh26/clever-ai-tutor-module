...
"[project]/stores/auth-store.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/stores/session-store.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$auth$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/stores/auth-store.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$session$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/stores/session-store.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function AuthProvider({ children }) {
    ...
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$session$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSessionStore"])((state)=>state.user);
    const loading = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$session$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSessionStore"])((state)=>state.loading);
    const error = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$session$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSessionStore"])((state)=>state.error);
    const setSessionUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$session$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSessionStore"])((state)=>state.setSession);
    const setSessionLoading = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$session$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSessionStore"])((state)=>state.setLoading);
    const setSessionError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$session$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSessionStore"])((state)=>state.setError);
    const clearSessionStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$session$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSessionStore"])((state)=>state.clearSession);
    const isAuthenticated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$auth$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthStore"])((state)=>state.isAuthenticated);
    const setAuthenticated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$auth$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthStore"])((state)=>state.setAuthenticated);
    const clearAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$stores$2f$auth$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuthStore"])((state)=>state.clearAuth);
    const clearAuthState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        setAccessToken(null);
        setRole(null);
        clearAuth();
        clearSessionStore();
    ...
    const refreshSession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        try {
            ...
            if (err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiError"] && err.status === 401) {
                clearAuthState();
                return;
            }
            setRole(null);
    ...
    const startLogin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0f1b8859._.js.map